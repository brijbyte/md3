...
// One full wave-phase cycle (--_wave-phase: 0 -> 1) is
              ...
              style={
                {
                  ...
                  transform: `rotate(calc(var(--_wave-phase) * ${WAVE_PHASE_ROTATION_DEG}deg))`,
                  ...
                  strokeDashoffset: indeterminate
                    ? undefined
                    : `calc(var(--_wave-phase) * ${-WAVE_PHASE_DASH_PERCENT}%)`,
