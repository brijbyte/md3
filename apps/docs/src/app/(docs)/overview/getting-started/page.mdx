...
Every page on this site is also served as plain markdown — append `.md` to any page URL
(this page: [/overview/getting-started.md](/overview/getting-started.md)). The full index
lives at [/llms.txt](/llms.txt); point an agent there and it can navigate the whole
library, including each demo's standalone source files under `/demo-src/`.
