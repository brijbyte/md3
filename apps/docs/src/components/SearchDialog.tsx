...
// Platform-dependent shortcut hint; empty until hydration so server markup
// (which can't know the OS) never mismatches.
function useIsMac() {
...
// Sidebar trigger, styled as a compact MD3 search bar.
...
// Compact trigger for the sub-xl header (sidebar hidden below md).
export function SearchIconButton() {
  const keys = useShortcutHint();
  return (
    <Button variant="outlined" aria-label={`Search the docs. Press ${keys}`} onClick={openSearch}>
